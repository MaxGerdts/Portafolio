  ...
  return (
    <section id='skills' className='skills'>
      <div className='container'>
        ...
        <h3 className='skills__subtitles'>Frameworks y Tecnologías</h3>
        ...
        <h3 className='skills__subtitles'>Lenguajes y Librerías</h3>
        <div className='skills__contentRow'>
          <div className='skills__contentCol'>
            <div className='skills__content'>
              <div className='skills__label'>
        ...
        <h3 className='skills__subtitles'>Otros</h3>
        <div className='skills__contentRow'>
          <div className='skills__contentCol'>
            <div className='skills__content'>
              <div className='skills__label'>
